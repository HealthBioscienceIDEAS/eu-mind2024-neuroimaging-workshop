...
1. **Using the man command** Just type `man` in front of it to get the *manual entry*.
    ...
    man less
    ```
2. **Use the -h option** Many commands will provide more information about how to use
...
with the `dcm12niix` command mentioned above to convert a DICOM file set to a Nifti.
    ...
    ```
3. **Search for help on the command online** - this can be helpful if you want more information, tutorials or if for some reason
